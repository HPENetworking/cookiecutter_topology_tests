# -*- coding: utf-8 -*-
#
# Your testing project name documentation build configuration file.
#
...
project = 'Your testing project name'
...
htmlhelp_basename = 'your_tests_repo_namedoc'
...
latex_documents = [
    (
        'index', 'your_tests_repo_name.tex',
        'Your testing project name Documentation',
...
autoapi_modules = {
    ...
    'topology_lib_vtysh.library': {
        'output': 'autoapi'
    },
    'topology_lib_vtysh.parser': {
        'output': 'autoapi'
    },
    'testsuite': {
        'output': 'autoapi',
